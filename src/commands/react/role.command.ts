    ...
    if (customEmoji) {
      ...
      if (!unicodeEmoji) {
        return interaction
          ...
          .catch((e) => {
            log.error(`Failed to alert user of invalid emojis.`);
            log.error(`${e}`);
          });
      }
